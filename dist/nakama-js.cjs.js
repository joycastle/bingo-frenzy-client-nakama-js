...
var NakamaApi = function (configuration) {
    ...
    var napi = {
        ...
        authenticateApple: function (body, create, username, options) {
            if (options === void 0) { options = {}; }
            if (body === null || body === undefined) {
                throw new Error("'body' is a required parameter but is null or undefined.");
            }
        ...
        linkApple: function (body, options) {
            if (options === void 0) { options = {}; }
            if (body === null || body === undefined) {
                throw new Error("'body' is a required parameter but is null or undefined.");
            }
        ...
        unlinkApple: function (body, options) {
            if (options === void 0) { options = {}; }
            if (body === null || body === undefined) {
                throw new Error("'body' is a required parameter but is null or undefined.");
            }
        ...
        rpcFunc: function (id, body, httpKey, options) {
            if (options === void 0) { options = {}; }
            if (id === null || id === undefined) {
                throw new Error("'id' is a required parameter but is null or undefined.");
            }
...
var DefaultSocket = (function () {
    ...
    DefaultSocket.prototype.convertRecvData = function (data) {
        ...
        return Buffer.from(pako.inflateRaw(recvBuff.slice(0, recvBuff.length - 1))).toString();
    };
